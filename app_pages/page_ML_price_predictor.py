...
def page_ML_price_predictor_content():
    ...
    "* Applying PCA did not significantly improve the model's" 
    " performance, suggesting that the original feature set" 
    " was already well-suited for the regression task.\n"
