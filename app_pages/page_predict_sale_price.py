...
def page_sale_price_predictor_body():
    ...
    if st.button("Run Predictive Analysis"):
        ...
        st.write("* Given the features provided for the property, the model has predicted a sale value of:")
    ...
    if st.button("Run Prediction on Inherited Homes"):
        ...
        st.write(f"* The total value of the inherited homes is estimated to be:")
